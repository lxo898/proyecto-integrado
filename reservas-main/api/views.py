...
class ReservationCreateView(LoginRequiredMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        # Solicitudes de recursos desde el formulario (no crea recursos nuevos)
        ...
        # Anexa al comentario (purpose) para que quede trazabilidad visible en historial/CSV
        ...
        # Notificar a admins con el resumen de recursos (si se pidió)
...
def export_reservations_csv(request):
    ...
    # Incluye Comentario (purpose) y Notas aprobación (Approval.notes)
