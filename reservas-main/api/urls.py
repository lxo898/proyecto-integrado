...
from .views import (
    ...
    calendar_view,                 # ← si ya lo tienes creado para FullCalendar
)
...
urlpatterns = [
    ...
    # ---- Password reset (NOMBRES estándar que pide la plantilla) ----
    path(
        "password-reset/",
    ...
    path("calendario/", calendar_view, name="calendar"),   # ← ruta del calendario
